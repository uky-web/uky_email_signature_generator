...
jQuery(document).ready(function() {
  // update company name
  jQuery('#company-name').text(companyName);
  ...
  jQuery.when(getTeamImages()).done(function(results){
    jQuery(results).find("a:contains(" + fileExt + ")").each(function () {
      teamImgs.push(jQuery(this).text().trim());
    });
